...
User.profile_data = relationship('ProfileData', order_by=ProfileData.id, back_populates='user')
Message.profile_data = relationship('ProfileData', order_by=ProfileData.id, back_populates='message')